...
from the main ``amplifier_module_engram_lite.tools.amplifier_tool`` submodule.
"""

__amplifier_module_type__ = "tool"

from amplifier_module_engram_lite.tools.amplifier_tool import mount  # noqa: F401
